...
public class ShaderPackFactory {
    ...
    public static ShaderPack loadShaderPack(Path root, Map<String, String> changedConfigs,
        ...
        return new ShaderPack(root, changedConfigs, environmentDefines, isZip);
    }

    public static ShaderPack loadShaderPack(Path root, ImmutableList<StringPair> environmentDefines,boolean isZip)
            throws IOException, IllegalStateException {
