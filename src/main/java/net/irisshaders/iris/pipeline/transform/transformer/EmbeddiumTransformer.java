...
//			root.replaceReferenceExpressions(t, "at_tangent", "irs_Tangent");
    ...
    public static void injectVertInit(
            ...
            TranslationUnit tree,
            Root root,
            EmbeddiumParameters parameters, boolean needsNormal) {
        ...
        tree.parseAndInjectNodes(t, ASTInjectionPoint.BEFORE_DECLARATIONS,
                ...
                "float _material_mip_bias(uint material) {\n" +
                        ...
                        "}",
                "void _vert_init() {" +
                        "_vert_position = (vec3(a_Position.xyz) * 4.8828125E-4f + -8.0f"
                        + ");" +
                ...
                "vec3 _get_draw_translation(uint pos) {\n" +
                        ...
                        "}");
        addIfNotExists(root, t, tree, "a_Position", Type.U32VEC4, StorageQualifier.StorageType.IN);
