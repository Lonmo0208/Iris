...
//		VERTEX_FORMAT.addElement(IrisChunkMeshAttributes.toChunkMeshAttribute(attribute), pointer,attribute.format(),  attribute.count(), attribute.normalized(), attribute.intType());
//	}
}
