...
public class EmbeddiumShader extends ChunkShaderInterface {
	...
	//private GlUniformFloat2v uniformTexCoordShrink;
	...
	public void setupState() {
		...
		double subTexelOffset = 1.0f / 32768;

		//if (this.uniformTexCoordShrink != null) {
			//this.uniformTexCoordShrink.set(
					//(float) (subTexelOffset - (((1.0D / ((TextureAtlasAccessor) textureAtlas).callGetWidth())))),
					//(float) (subTexelOffset - (((1.0D / ((TextureAtlasAccessor) textureAtlas).callGetHeight()))))
			//);
		//}
