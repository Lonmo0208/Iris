...
public final class EmbeddiumParameters extends SodiumParameters {
	...
	private static net.irisshaders.iris.gl.state.ShaderAttributeInputs inputs;
	...
	public static void setInputs(net.irisshaders.iris.gl.state.ShaderAttributeInputs inputs) {
		EmbeddiumParameters.inputs = inputs;
	}
