...
import net.irisshaders.iris.compat.iris.impl.EmbeddiumCoreTransformer;
import net.irisshaders.iris.compat.iris.impl.EmbeddiumParameters;
import net.irisshaders.iris.compat.iris.impl.EmbeddiumPatch;
import net.irisshaders.iris.compat.iris.impl.EmbeddiumTransformer;
