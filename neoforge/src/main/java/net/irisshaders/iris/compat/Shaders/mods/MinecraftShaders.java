...
@EventBusSubscriber(modid = net.irisshaders.iris.platform.IrisForgeMod.MODID, value = Dist.CLIENT, bus = EventBusSubscriber.Bus.MOD)
public class MinecraftShaders {
    ...
    public static ResourceLocation SCREEN = ResourceLocation.fromNamespaceAndPath(net.irisshaders.iris.platform.IrisForgeMod.MODID, "screen");
