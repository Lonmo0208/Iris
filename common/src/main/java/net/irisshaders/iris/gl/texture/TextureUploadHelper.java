...
public class TextureUploadHelper {
	...
	public static void resetTextureUploadState() {
		...
		GlStateManager._pixelStore(GL46C.GL_UNPACK_ROW_LENGTH, 0);
		GlStateManager._pixelStore(GL46C.GL_UNPACK_SKIP_ROWS, 0);
		GlStateManager._pixelStore(GL46C.GL_UNPACK_SKIP_PIXELS, 0);
		GlStateManager._pixelStore(GL46C.GL_UNPACK_ALIGNMENT, 4);
	}
}
