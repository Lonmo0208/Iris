...
val SODIUM_DEPENDENCY_FABRIC by extra { files(rootDir.resolve("custom_sodium").resolve("sodium-fabric-0.8.3-OGL46-SNAPSHOT+mc1.21.11-local.jar")) }
val SODIUM_DEPENDENCY_NEO by extra { files(rootDir.resolve("custom_sodium").resolve("sodium-neoforge-0.8.3-OGL46-SNAPSHOT+mc1.21.11-local-mod.jar")) }
