...
val SODIUM_DEPENDENCY_FABRIC by extra { files(rootDir.resolve("custom_sodium/sodium-fabric-0.8.6.1-SNAPSHOT+mc1.21.11-local.jar")) }
val SODIUM_DEPENDENCY_NEO by extra { files(rootDir.resolve("custom_sodium/net.caffeinemc.sodium-neoforge-0.8.6.1+mc1.21.11-mod.jar")) }
